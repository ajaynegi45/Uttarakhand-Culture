...
import {Mountain, MoveLeft, Hammer} from "lucide-react";
...
export default function UnderConstructionPage() {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 pt-25 text-center animate-fade-in relative overflow-hidden">
        ...
        <div className="z-10 max-w-lg w-full flex flex-col items-center space-y-12">
            ...
            <div className="relative w-24 h-24 flex items-center justify-center">
                ...
                <div className="absolute inset-0 border-t-2 border-[var(--secondary)] rounded-full animate-spin duration-[3s]"></div>
            ...
            {/* Status Card */}
            <div className="w-full bg-[var(--card)] border border-[var(--border)] p-6 rounded-[var(--radius)] shadow-sm">
